 ...
 */
package com.foxelbox.foxellog.redis;
...
public class RedisQueueThread extends Thread {
    public RedisQueueThread() {
        setName("FoxelLog-RedisQueueThread");
        setDaemon(true);
    }
				...
				try {
					while (!actionsQueue.isEmpty()) {
						...
						if (actionObject == null)
							continue;
                        FoxelLog.instance.redisManager.lpush("logstash", actionObject.toJSONObject().toJSONString());
					}
				} catch (Exception e) {
					e.printStackTrace();
				}
